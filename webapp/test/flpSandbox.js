		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "People list",
									"targetURL": "#beapeduzsd_000_people-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapeduzsd_000_people-display": {
								"semanticObject": "beapeduzsd_000_people",
								"action": "display",
								"description": "Provides a list of people",
								"title": "People list",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.edu.zsd_000_people",
									"url": sap.ui.require.toUrl("be/ap/edu/zsd_000_people")
								}
							}
						}
					}
