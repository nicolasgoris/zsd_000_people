sap.ui.define([
    ...
    return BaseController.extend("be.ap.edu.zsd_000_people.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("TypeName", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "be.ap.edu.zsd_000_people.view.ViewSettingsDialog",
                    controller: this
